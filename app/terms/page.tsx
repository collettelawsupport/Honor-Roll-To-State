...
export default function TermsPage() {
  return (
    <LegalShell eyebrow="Effective August 31, 2026" title="Terms of Use">
      <p>These terms govern use of the Texas Our Little Miss Honor Roll State Registration service, including its connected QuickBooks Online invoicing workflow.</p>
