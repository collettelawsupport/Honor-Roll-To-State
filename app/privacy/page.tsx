...
export default function PrivacyPage() {
  return (
    <LegalShell eyebrow="Effective August 31, 2026" title="Privacy Policy">
      <p>This policy describes how Texas Our Little Miss handles information submitted through the Honor Roll State Registration service and its connected QuickBooks Online workflow.</p>
