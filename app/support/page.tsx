...
export default function SupportPage() {
  return (
    <LegalShell eyebrow="Registration assistance" title="Support">
      <p>For help with an Honor Roll or Winner&apos;s Circle registration, a QuickBooks invoice, payment status, or the contestant Big Form, email <a href="mailto:texasolm2@gmail.com">texasolm2@gmail.com</a>.</p>
      ...
      <p><a className="button-primary legal-button" href="mailto:texasolm2@gmail.com?subject=Honor%20Roll%20registration%20support">Email registration support</a></p>
    </LegalShell>
  );
}
